...
class VisualizationManager:
    ...
    def visualize_mcts_tree(self, mcts_tree: Dict[str, Any], title: str = "MCTS Tree"):
        ...
        def add_node(
            node_id: str, node_data: Dict[str, Any], parent: Optional[str] = None
        ):
            ...
            if "children" in node_data:
                for child_id, child_data in node_data["children"].items():
                    add_node(child_id, child_data, node_id)

        # Add root node
        root_id = "root"
        add_node(root_id, mcts_tree)
        ...
        plt.title(title)
        plt.savefig(self._get_output_path("mcts_tree"))
        plt.close()
